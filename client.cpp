...
/*   Updated: 2022/09/15 02:11:34 by alee             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Client::setUserFileTransFlag(bool flag)
{
	this->file_trans_flag = flag;
	return ;
}

bool	Client::getUserFileTransFlag(void) const
{
	return (this->file_trans_flag);
}
